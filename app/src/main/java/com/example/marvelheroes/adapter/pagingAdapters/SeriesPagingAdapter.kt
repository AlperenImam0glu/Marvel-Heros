    ...
    inner class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(data: SeriesResults) {
            ...
            binding.cardItemView.setOnClickListener {
                ...
                try {
                    if(flag){
                        val action = HomePageFragmentDirections.actionHomePageFragmentToCharacterDetailPageFragment(4,  Enums.Series)
                ...
                try {
                    if(flag){
                        val action =
                            CharacterDetailPageFragmentDirections.detailPageFragmentToDetailPageFragment(4,Enums.Series)
                        Navigation.findNavController(it).navigate(action)
                        flag = false
                    }
                }catch (e:Exception){}
